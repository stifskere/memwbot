...
/// When a guild member is added this function
/// registered at [super] will salute and give
/// a role.
pub async fn guild_member_add(context: Context, member: Member) -> Result<(), Box<dyn StdError>> {
